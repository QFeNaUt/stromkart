...
from app.routers import flows, prices, zones, reservoirs, balance, analysis
...
app.add_middleware(
    ...
    allow_methods=["GET"],   # nettlesere skal kun lese; POST (analyse-push) går utenom CORS med Bearer-token
    allow_headers=["*"],
)
